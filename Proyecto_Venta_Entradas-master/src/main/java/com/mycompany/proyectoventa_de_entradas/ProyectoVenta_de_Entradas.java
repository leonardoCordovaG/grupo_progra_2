...
public class ProyectoVenta_de_Entradas extends JFrame {
    ...
    // --- Lista de ventas compartida (para módulo admin de anulaciones) ---
    ...
    // Navegación central — llama refresh en cada vista al mostrarse
    ...
    // Abre el dashboard de administración como ventana independiente
    public void abrirDashboardAdmin() {
        SwingUtilities.invokeLater(() -> {
            frmAdminDashboard dashboard = new frmAdminDashboard();
            new ControladorAdminDashboard(dashboard, Concierto.getCatalogo(), listaVentas).iniciar();
        });
    }
